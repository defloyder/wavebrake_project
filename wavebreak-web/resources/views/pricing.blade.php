...
@section('description', 'Тарифы WAVEBREAK: личный кабинет, подключение по одной ссылке и канал, который держит форму даже при активных блокировках.')
        ...
        <div class="wb-container wb-page-hero-grid">
            <div>
                ...
                <p class="wb-lead">
                    ...
                    оплатили, открыли кабинет, получили ссылку с QR-кодом.
                </p>
            </div>
                ...
                @php
                    ...
                    $copy = match (true) {
                        str_contains($code, 'starter') => [
                            ...
                            ['Один линк — QR-код и ссылка', 'Канал сам держит форму при блокировках', 'Личный кабинет со статусом']
                        ],
                        ...
                        default => [
                            ...
                            ['Личный кабинет', 'Одна ссылка на подключение', 'Понятный статус']
                        ],
                    };
                @endphp
    ...
    <section class="wb-section wb-split-section">
        <div class="wb-container wb-split">
            <div>
                ...
                <h2>Открываете кабинет — подключение уже готово</h2>
                <p>
                    Тариф активируется сразу. В кабинете — QR-код и ссылка: сканируете
                    в приложении или копируете вручную. Настраивать транспорт не нужно, он выбирается сам.
                </p>
            </div>
