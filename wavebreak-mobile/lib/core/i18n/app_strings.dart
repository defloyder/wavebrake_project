...
class AppStrings {
  const AppStrings({
    ...
    required this.resolvingFastest,
    required this.speedtestTap,
    required this.speedtestTesting,
    required this.speedtestDownload,
    required this.speedtestUpload,
    required this.speedtestPing,
  ...
  final String resolvingFastest;
  final String speedtestTap;
  final String speedtestTesting;
  final String speedtestDownload;
  final String speedtestUpload;
  final String speedtestPing;
...
const kEnglishStrings = AppStrings(
  ...
  resolvingFastest: 'Finding the fastest server…',
  speedtestTap: 'Tap to test your speed',
  speedtestTesting: 'Measuring your connection…',
...
const kRussianStrings = AppStrings(
  ...
  resolvingFastest: 'Подбираем самый быстрый сервер…',
  speedtestTap: 'Нажмите, чтобы проверить скорость',
  speedtestTesting: 'Измеряем соединение…',
  speedtestDownload: 'Загрузка',
  speedtestUpload: 'Отдача',
  speedtestPing: 'Пинг',
  speedtestRetest: 'Проверить снова',
  mbpsUnit: 'Мбит/с',
...
const kSpanishStrings = AppStrings(
  ...
  resolvingFastest: 'Buscando el servidor más rápido…',
  speedtestTap: 'Toca para probar tu velocidad',
  speedtestTesting: 'Midiendo tu conexión…',
...
const kGermanStrings = AppStrings(
  ...
  resolvingFastest: 'Schnellsten Server wird gesucht…',
  speedtestTap: 'Tippen, um die Geschwindigkeit zu testen',
  speedtestTesting: 'Verbindung wird gemessen…',
  speedtestDownload: 'Download',
  speedtestUpload: 'Upload',
  speedtestPing: 'Ping',
...
const kFrenchStrings = AppStrings(
  ...
  resolvingFastest: 'Recherche du serveur le plus rapide…',
  speedtestTap: 'Touchez pour tester votre vitesse',
  speedtestTesting: 'Mesure de la connexion…',
  speedtestDownload: 'Téléchargement',
  speedtestUpload: 'Envoi',
  speedtestPing: 'Ping',
  speedtestRetest: 'Tester à nouveau',
  mbpsUnit: 'Mbit/s',
...
const kPortugueseStrings = AppStrings(
  ...
  resolvingFastest: 'Procurando o servidor mais rápido…',
  speedtestTap: 'Toque para testar sua velocidade',
  speedtestTesting: 'Medindo sua conexão…',
  speedtestDownload: 'Download',
  speedtestUpload: 'Upload',
  speedtestPing: 'Ping',
...
const kTurkishStrings = AppStrings(
  ...
  resolvingFastest: 'En hızlı sunucu aranıyor…',
  speedtestTap: 'Hızını test etmek için dokun',
  speedtestTesting: 'Bağlantı ölçülüyor…',
