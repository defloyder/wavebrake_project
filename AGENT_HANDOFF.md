...
- Результат локальной проверки 18.09.2026: 9 Laravel-тестов, 87 assertions; 20 браузерных сценариев (4 страницы, ширины 320/390/768/1440/1920), reduced motion, отображение без JS и корректность JSON-LD. Проверяются прокрутка, меню, FAQ, изображения, пиксели canvas и отсутствие обрезанного текста в превью.
