// Copyright (c) 2023 Toby, MIT licensed. Copied unmodified from
// github.com/apernet/hysteria (app/internal/socks5/server.go) — that
// package lives under an `internal/` directory, so it can't be imported
// from outside the hysteria module tree; this is the permitted way to
// reuse an MIT-licensed file rather than reimplementing a SOCKS5 server
// from scratch. Do not hand-edit; re-copy from upstream instead.
package socks5
