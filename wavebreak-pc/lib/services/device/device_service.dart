...
class DeviceService {
  ...
  Future<DeviceItem> _register() async {
    ...
    final device = await _gateway.registerDevice(platform: platform, name: name);
    ...
    try {
      switch (defaultTargetPlatform) {
        ...
        case TargetPlatform.windows:
          ...
          return ('windows', windows.computerName.isNotEmpty ? windows.computerName : 'Windows device');
        case TargetPlatform.macOS:
          final mac = await info.macOsInfo;
          return ('macos', mac.computerName.isNotEmpty ? mac.computerName : 'Mac');
        case TargetPlatform.linux:
          final linux = await info.linuxInfo;
          return ('linux', linux.prettyName.isNotEmpty ? linux.prettyName : 'Linux device');
